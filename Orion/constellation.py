...
plt.subplot(1,1,1)
plt.scatter(x,y)
fig = plt.savefig('2d_constellation.png')
plt.show()
...
#creating axis object to allow for ticksize change
constellation3d = fig_3d.add_subplot(1,1,1,projection="3d")

#s= 80 to make 3d projection legible, green cause... is pretty.
constellation3d.scatter(x,y,z, s=80, c = 'green')
